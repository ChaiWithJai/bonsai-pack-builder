...
This repo uses these sources as the starting evidence base.
...
- [LangChain Deep Agents JavaScript overview](https://docs.langchain.com/oss/javascript/deepagents/overview)
- [LangChain Deep Agents JavaScript reference](https://reference.langchain.com/javascript/deepagents)
- [LangChain Deep Agents GitHub repo](https://github.com/langchain-ai/deepagents)
- [HashiCorp RFC template](https://www.hashicorp.com/en/how-hashicorp-works/articles/rfc-template)
- [Nomad Pack custom packs guide](https://developer.hashicorp.com/nomad/tools/nomad-pack/create-packs)
...
## Source claims we should keep stable

- Deep Agents provides planning, subagents, file systems, memory, tools, and human
  approval controls.
- HashiCorp RFCs are used to create clarity before a change affects many people.
- Nomad Pack packages repeatable workload patterns as packs and registries.
